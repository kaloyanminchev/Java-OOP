...
import library.appenders.ConsoleAppender;
import library.appenders.FileAppender;
import library.enums.ReportLevel;
import library.utils.FileLogger;
import library.layouts.Layout;
import library.layouts.SimpleLayout;
import library.layouts.XmlLayout;
import library.loggers.Logger;
import library.loggers.MessageLogger;
    ...
    public static void main(String[] args) {
        ...
        while (n-- > 0) {
            ...
            if (appenderType.equals("ConsoleAppender")) {
                ...
                appender = new FileAppender(layout, new FileLogger());
            }
